      ...
      <div className="top">
        ...
        <div className="right">
          <div className="lg-link-item">
            {desktop_menuItems.map((link) => <Link className="text-24 text-400" key={link.title} to={link.url}>{link.title}</Link>)}
          </div>
          ...
          <div key={index} className="item-section">
            ...
            {item.links && <div className="items">
              {item.links.map((link, linkIndex) => (
                <Link className="text-400" key={linkIndex} to={link.href}>
                  {link.label}
                </Link>
              ))}
            </div>}
